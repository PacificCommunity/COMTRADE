...
#      One_Year <- Canned_Tuna_Imports_and_Exports[Year == 2020]
      ...
      Imports <- One_Year[order(One_Year$Year, -One_Year$Import), c("Year", "reporter_desc", "variable", "Import")]
      Exports <- One_Year[order(One_Year$Year, -One_Year$Export), c("Year", "reporter_desc", "variable", "Export")]
