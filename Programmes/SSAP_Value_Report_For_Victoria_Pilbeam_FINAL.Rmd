...
output: 
   bookdown::word_document2:
      reference_docx: "C:\\From BigDisk\\GIT\\COMTRADE\\Product_Output\\Word_Template.docx"
      toc: false  
      figure:
        style: Table
        layout: autofit
...
references:
- id: FFA
  title: Value of WCPFC-CA Tuna Fisheries 2024
  author:
  - family: FFA
...
##
   load("C:\\From BigDisk\\GIT\\COMTRADE\\Data_Output\\Vessels.rda")
   load("C:\\From BigDisk\\GIT\\COMTRADE\\Data_Output\\FAO_Core_Tuna.rda")
   load("C:\\From BigDisk\\GIT\\COMTRADE\\Data_Output\\FFA_Core_Tuna.rda")
   load("C:\\From BigDisk\\GIT\\COMTRADE\\Data_Intermediate\\FFA_Compendium_of_Economic_and_Development_Statistics_2024.rda")



options(xtable.comment = FALSE)

BaseDir <- "C:\\From BigDisk\\GIT\\COMTRADE\\Graphical_Output\\"
...
##
      ...
      License_Revenues <- rbind(License_Revenues[order(-License_Revenues$`2023`),],
...
* Exponential vessel growth rates from between 1977 – 2024.
...
knitr::kable(License_Revenues,
               row.names = FALSE,
               format = "markdown",
               booktabs = TRUE,
               caption= "Access fees for offshore fishing 2008–2024 (or latest year)")
```
