...
##
   ...
   ##
      Import_Export_in_Domestic_Currency <- Comtrade_Fish_Data[(partner_desc %in% c("American Samoa","Areas, nes","Australia","Cambodia","China","China, Hong Kong SAR","China, Macao SAR","Cook Isds",
