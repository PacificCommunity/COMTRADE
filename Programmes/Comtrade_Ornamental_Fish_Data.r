##
##    Programme:  Comtrade_Ornamental_Fish_Data.r
##
##    Objective:  Builds off the Comtrade_Fish_Data.r Programme
##                The purpose of the request is to carry out an economic 
##                assessment on the pet fish industry back in Kiritimati 
##                to support the Ministry in leveraging its management 
##                measures through regulating benchmark prices for each 
##                of the species targeted for export.
##
##                https://spccloud.sharepoint.com/sites/fameteam/Lists/member_request/DispForm.aspx?ID=646
##
##    Author:     James Hogan, FAME - The Pacific Community (SPC), 10 December 2025
##
##
   ##
   ##    Clear the memory
   ...
   ##
      ...
      All_Codes <- data.table(Description = ct_commodity_lookup(c("Ornamental", "ornamental"),return_char = TRUE))
      All_Codes <- unique(All_Codes[str_detect(toupper(All_Codes$Description), "FISH"),])
